...
{
    public abstract class ElevationsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ElevationsWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ElevationsWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ElevationsDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ElevationsDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ElevationsDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ElevationsDbContext, Task<T>> func)
        {
            T result;
