namespace Elevations.EntityFrameworkCore.Seed.Host
{
    ...
    public class HostRoleAndUserCreator
    {
        ...
        public HostRoleAndUserCreator(ElevationsDbContext context)
        {
            _context = context;
        }
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            Role? adminRoleForHost = _context.Roles.IgnoreQueryFilters()
            ...
            List<string> grantedPermissions = _context.Permissions.IgnoreQueryFilters().OfType<RolePermissionSetting>()
                .Where(p => p.TenantId == null && p.RoleId == adminRoleForHost.Id).Select(p => p.Name).ToList();
                ...
                _context.Permissions.AddRange(
                    permissions.Select(
                        permission => new RolePermissionSetting
                                          {
                                              TenantId = null, Name = permission.Name, IsGranted = true,
            ...
            User? adminUserForHost = _context.Users.IgnoreQueryFilters()
                .FirstOrDefault(u => u.TenantId == null && u.UserName == AbpUserBase.AdminUserName);
            if (adminUserForHost == null)
            {
                User user = new User
                                {
                                    TenantId = null, UserName = AbpUserBase.AdminUserName, Name = "admin",
                                    Surname = "admin", EmailAddress = "admin@aspnetboilerplate.com",
