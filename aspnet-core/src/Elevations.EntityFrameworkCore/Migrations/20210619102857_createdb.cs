        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Bath = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CityFee = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    MaxNumberOfDays = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MinNumberOfDays = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MonthlyPlan = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NightlyPlan = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Price = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WeekendPlan = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WeeklyPlan = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Bath = table.Column<long>(type: "bigint", nullable: false),
                    Bed = table.Column<long>(type: "bigint", nullable: false),
                    RoomsCategory = table.Column<int>(type: "int", nullable: true),
                    CategoryId = table.Column<long>(type: "bigint", nullable: false),
                    CategoryName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CityFee = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CleaningFee = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rooms_RoomsCategory_RoomsCategory",
                        column: x => x.RoomsCategory,
